...
public class FeeEvaluationServiceTest {
    ...
    // List<ClientProduct> clientProducts = Arrays.asList(clientAccountProduct,
    // clientAccount2Product,
    // clientLoanProduct);
    ...
    // assert clientAccountProduct.getBalance().compareTo(expectedAccountBalance) ==
    // 0;
    // // Verify no deduction from the second account product
    // assert clientAccount2Product.getBalance().compareTo(new BigDecimal("1000"))
    // == 0;
    // }
}